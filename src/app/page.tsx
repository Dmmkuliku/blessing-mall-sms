...
const ROLES: {
...
}[] = [
  {
    ...
    sw: "Mhudumu wa Duka",
    description: "Run the till, serve customers, and ring up mauzo.",
  ...
  },
  {
    ...
    title: "Store Manager",
    sw: "Meneja wa Duka",
    description: "Manage stock, purchases, suppliers, and daily reports.",
  ...
  },
  {
    ...
    title: "Store Owner",
    sw: "Mmiliki wa Duka",
    description: "Full control — staff, expenses, settings, and insights.",
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-8 sm:px-8 lg:py-12">
        ...
        <div className="mt-10 grid flex-1 items-center gap-10 lg:mt-14 lg:grid-cols-[1.05fr_0.95fr]">
          <section className="animate-fade-up text-white">
            ...
            <p className="mt-4 max-w-md text-base text-white/85 sm:text-lg">
              Run mauzo, stoki, and staff from one calm counter — built for
              Tanzanian supermarket floors.
            </p>
            ...
            {!selected ? (
              <>
                ...
                <p className="mt-1 text-sm text-muted">
                  Chagua akaunti yako — then continue with your login.
                </p>
        ...
        <footer className="mt-10 text-center text-xs text-white/65 sm:text-left">
          Asante · Built for Blessing Mall, Dar es Salaam
        </footer>
      </div>
    </div>
  );
